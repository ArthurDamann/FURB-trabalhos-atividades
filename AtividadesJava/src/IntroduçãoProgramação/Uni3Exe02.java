...
public class Uni3Exe02 {
    ...
    double preçoparsapatos;

    System.out.println("Preço do par do sapato: ");
    preçoparsapatos = teclado.nextDouble();

    double valordesconto = preçoparsapatos * 0.12;
    double precoparsapatosdesconto = preçoparsapatos - valordesconto;
