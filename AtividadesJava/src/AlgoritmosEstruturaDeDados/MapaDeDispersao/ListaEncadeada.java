...
public class ListaEncadeada<T> {
    ...
    public NoLista<T> buscar(T info) {
        ...
        while (p != null) {
            if (p.getInfo().equals(info)) {
                return p; // Corrigido: retorna o nó encontrado
            }
            p = p.getProximo();
        }
    ...
    public void retirar(T info) {
        ...
        if (p != null) { // Se o nó foi encontrado
            if (p == primeiro) {
                primeiro = p.getProximo(); // Remove do início
            } else {
                anterior.setProximo(p.getProximo()); // Remove do meio/fim
            }
        }
    }
    ...
    public String toString() {
        ...
        while (p != null) {
            ...
            if (p.getProximo() != null) {
                sb.append(" -> "); // Corrigido: adiciona separador
            }
            p = p.getProximo();
        }
        return sb.toString();
